...
class GetCommentsResponsePublicComment {
  /// Returns a new [GetCommentsResponsePublicComment] instance.
  ...
  /// Returns a new [GetCommentsResponsePublicComment] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetCommentsResponsePublicComment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetCommentsResponsePublicComment(
  ...
  static List<GetCommentsResponsePublicComment> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetCommentsResponsePublicComment>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetCommentsResponsePublicComment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetCommentsResponsePublicComment> mapFromJson(dynamic json) {
    final map = <String, GetCommentsResponsePublicComment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetCommentsResponsePublicComment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetCommentsResponsePublicComment-objects as value to a dart map
  static Map<String, List<GetCommentsResponsePublicComment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetCommentsResponsePublicComment>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetCommentsResponsePublicComment.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
