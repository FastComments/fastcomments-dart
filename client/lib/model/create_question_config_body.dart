...
class CreateQuestionConfigBody {
  /// Returns a new [CreateQuestionConfigBody] instance.
  ...
  /// Returns a new [CreateQuestionConfigBody] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateQuestionConfigBody? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateQuestionConfigBody> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateQuestionConfigBody>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateQuestionConfigBody.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateQuestionConfigBody> mapFromJson(dynamic json) {
    final map = <String, CreateQuestionConfigBody>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateQuestionConfigBody.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateQuestionConfigBody-objects as value to a dart map
  static Map<String, List<CreateQuestionConfigBody>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateQuestionConfigBody>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateQuestionConfigBody.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
