...
class UpdateUserNotificationPageSubscriptionStatusResponse {
  ...
  static UpdateUserNotificationPageSubscriptionStatusResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'status'), 'Required key "UpdateUserNotificationPageSubscriptionStatusResponse[status]" is missing from JSON.');
        assert(json[r'status'] != null, 'Required key "UpdateUserNotificationPageSubscriptionStatusResponse[status]" has a null value in JSON.');
        return true;
      }());
