...
class PageUsersOfflineResponse {
  /// Returns a new [PageUsersOfflineResponse] instance.
  ...
  /// Returns a new [PageUsersOfflineResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PageUsersOfflineResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PageUsersOfflineResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PageUsersOfflineResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PageUsersOfflineResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PageUsersOfflineResponse> mapFromJson(dynamic json) {
    final map = <String, PageUsersOfflineResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PageUsersOfflineResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PageUsersOfflineResponse-objects as value to a dart map
  static Map<String, List<PageUsersOfflineResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PageUsersOfflineResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PageUsersOfflineResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
