    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetTicketsResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetTicketsResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
