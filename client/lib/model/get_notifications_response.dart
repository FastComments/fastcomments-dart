...
class GetNotificationsResponse {
  ...
  static GetNotificationsResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'status'), 'Required key "GetNotificationsResponse[status]" is missing from JSON.');
        assert(json[r'status'] != null, 'Required key "GetNotificationsResponse[status]" has a null value in JSON.');
        assert(json.containsKey(r'notifications'), 'Required key "GetNotificationsResponse[notifications]" is missing from JSON.');
        assert(json[r'notifications'] != null, 'Required key "GetNotificationsResponse[notifications]" has a null value in JSON.');
        return true;
      }());
