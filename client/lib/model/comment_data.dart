...
class CommentData {
  ...
  static CommentData? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CommentData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommentData> mapFromJson(dynamic json) {
    final map = <String, CommentData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommentData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<CommentData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommentData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommentData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
