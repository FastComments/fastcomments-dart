...
class GetFeedPostsPublic200Response {
  /// Returns a new [GetFeedPostsPublic200Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetFeedPostsPublic200Response &&
  ...
  /// Returns a new [GetFeedPostsPublic200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetFeedPostsPublic200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'status'), 'Required key "GetFeedPostsPublic200Response[status]" is missing from JSON.');
        assert(json[r'status'] != null, 'Required key "GetFeedPostsPublic200Response[status]" has a null value in JSON.');
        assert(json.containsKey(r'feedPosts'), 'Required key "GetFeedPostsPublic200Response[feedPosts]" is missing from JSON.');
        assert(json[r'feedPosts'] != null, 'Required key "GetFeedPostsPublic200Response[feedPosts]" has a null value in JSON.');
        assert(json.containsKey(r'reason'), 'Required key "GetFeedPostsPublic200Response[reason]" is missing from JSON.');
        assert(json[r'reason'] != null, 'Required key "GetFeedPostsPublic200Response[reason]" has a null value in JSON.');
        assert(json.containsKey(r'code'), 'Required key "GetFeedPostsPublic200Response[code]" is missing from JSON.');
        assert(json[r'code'] != null, 'Required key "GetFeedPostsPublic200Response[code]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<GetFeedPostsPublic200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetFeedPostsPublic200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetFeedPostsPublic200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetFeedPostsPublic200Response> mapFromJson(dynamic json) {
    final map = <String, GetFeedPostsPublic200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetFeedPostsPublic200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetFeedPostsPublic200Response-objects as value to a dart map
  static Map<String, List<GetFeedPostsPublic200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetFeedPostsPublic200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetFeedPostsPublic200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
