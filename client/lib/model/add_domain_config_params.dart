...
class AddDomainConfigParams {
  /// Returns a new [AddDomainConfigParams] instance.
  ...
  /// Returns a new [AddDomainConfigParams] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AddDomainConfigParams? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AddDomainConfigParams> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AddDomainConfigParams>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AddDomainConfigParams.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AddDomainConfigParams> mapFromJson(dynamic json) {
    final map = <String, AddDomainConfigParams>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AddDomainConfigParams.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AddDomainConfigParams-objects as value to a dart map
  static Map<String, List<AddDomainConfigParams>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AddDomainConfigParams>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AddDomainConfigParams.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
