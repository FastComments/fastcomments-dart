...
class BulkCreateHashTagsResponseResultsInner {
  ...
  /// Returns a new [BulkCreateHashTagsResponseResultsInner] instance and imports its values from
  ...
  static List<BulkCreateHashTagsResponseResultsInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BulkCreateHashTagsResponseResultsInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BulkCreateHashTagsResponseResultsInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BulkCreateHashTagsResponseResultsInner> mapFromJson(dynamic json) {
    final map = <String, BulkCreateHashTagsResponseResultsInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BulkCreateHashTagsResponseResultsInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BulkCreateHashTagsResponseResultsInner-objects as value to a dart map
  static Map<String, List<BulkCreateHashTagsResponseResultsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BulkCreateHashTagsResponseResultsInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BulkCreateHashTagsResponseResultsInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
