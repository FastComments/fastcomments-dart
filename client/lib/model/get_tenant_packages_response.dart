    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetTenantPackagesResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetTenantPackagesResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
