...
class APIUserSubscription {
  /// Returns a new [APIUserSubscription] instance.
  APIUserSubscription({
  ...
  /// Returns a new [APIUserSubscription] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static APIUserSubscription? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<APIUserSubscription> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <APIUserSubscription>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = APIUserSubscription.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, APIUserSubscription> mapFromJson(dynamic json) {
    final map = <String, APIUserSubscription>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = APIUserSubscription.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of APIUserSubscription-objects as value to a dart map
  static Map<String, List<APIUserSubscription>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<APIUserSubscription>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = APIUserSubscription.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
